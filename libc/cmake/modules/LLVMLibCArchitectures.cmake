...
function(get_arch_and_system_from_triple triple arch_var sys_var)
  ...
  elseif(target_arch MATCHES "^amdgcn|^amdgpu")
  ...
  elseif(target_arch STREQUAL "mmix")
    set(target_arch "mmix")
  else()
    return()
  endif()
...
elseif(LIBC_TARGET_ARCHITECTURE STREQUAL "mmix")
  set(LIBC_TARGET_ARCHITECTURE_IS_MMIX TRUE)
else()
  message(FATAL_ERROR
