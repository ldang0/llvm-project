...
; CHECK-NEXT:  POP 0, 0
define i1 @compare_signed(i64 %lhs, i64 %rhs) {
...
; CHECK-NEXT:  POP 0, 0
define i1 @compare_signed_less_equal(i64 %lhs, i64 %rhs) {
...
; CHECK-NEXT:  POP 0, 0
define i1 @compare_signed_greater(i64 %lhs, i64 %rhs) {
...
; CHECK-NEXT:  ZSNP r231, [[CMP]], 1
; CHECK-NEXT:  POP 0, 0
define i1 @compare_unsigned(i64 %lhs, i64 %rhs) {
...
; CHECK-NEXT:  POP 0, 0
define i1 @compare_equal(i64 %lhs, i64 %rhs) {
...
; CHECK-NEXT:  ZSP r231, [[CMP]], 1
; CHECK-NEXT:  POP 0, 0
define i1 @compare_immediate(i64 %value) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @select_registers(i64 %lhs, i64 %rhs, i64 %true, i64 %false) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @select_true_immediate(i64 %lhs, i64 %rhs, i64 %false) {
...
; CHECK-NEXT:  OR r231, r233, 0
; CHECK-NEXT:  POP 0, 0
define i64 @select_false_immediate(i64 %lhs, i64 %rhs, i64 %true) {
...
; CHECK-NEXT:  OR r231, r233, 0
; CHECK-NEXT:  POP 0, 0
define ptr @select_pointer(i1 %condition, ptr %true, ptr %false) {
...
; CHECK-NEXT:  POP 0, 0
define i1 @compare_unsigned_boundary(i64 %value) {
