...
; CHECK-NEXT:  POP 0, 0
define i64 @and_registers(i64 %lhs, i64 %rhs) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @and_immediate(i64 %value) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @and_immediate_out_of_range(i64 %value) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @or_registers(i64 %lhs, i64 %rhs) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @or_immediate(i64 %value) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @xor_registers(i64 %lhs, i64 %rhs) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @xor_immediate(i64 %value) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @complement(i64 %value) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @and_complement(i64 %lhs, i64 %rhs) {
  %not = xor i64 %rhs, -1
...
; CHECK-NEXT:  POP 0, 0
define i64 @or_complement(i64 %lhs, i64 %rhs) {
  %not = xor i64 %rhs, -1
...
; CHECK-NEXT:  POP 0, 0
define i64 @nor_registers(i64 %lhs, i64 %rhs) {
  %or = or i64 %lhs, %rhs
  %result = xor i64 %or, -1
  ret i64 %result
}
...
; CHECK-NEXT:  POP 0, 0
define i64 @nand_registers(i64 %lhs, i64 %rhs) {
  %and = and i64 %lhs, %rhs
...
; CHECK-NEXT:  POP 0, 0
define i64 @nxor_registers(i64 %lhs, i64 %rhs) {
  %xor = xor i64 %lhs, %rhs
...
; CHECK-NEXT:  POP 0, 0
define i64 @and_complemented_immediate(i64 %value) {
  %result = and i64 %value, -256
  ret i64 %result
}
...
; CHECK-NEXT:  POP 0, 0
define i64 @or_complemented_immediate(i64 %value) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @nor_immediate(i64 %value) {
  %or = or i64 %value, 255
  %result = xor i64 %or, -1
  ret i64 %result
}
...
; CHECK-NEXT:  POP 0, 0
define i64 @nand_immediate(i64 %value) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @nxor_immediate(i64 %value) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @shift_left_immediate_boundary(i64 %value) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @shift_left_register(i64 %value, i64 %amount) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @shift_left_nsw(i64 %value) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @shift_right_arithmetic_immediate(i64 %value) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @shift_right_arithmetic_register(i64 %value, i64 %amount) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @shift_right_logical_immediate(i64 %value) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @shift_right_logical_register(i64 %value, i64 %amount) {
...
; CHECK-NEXT:  POP 0, 0
define i64 @shift_left_masked_register(i64 %value, i64 %amount) {
...
; CHECK-NEXT:  POP 0, 0
define i8 @shift_left_i8(i8 %value) {
