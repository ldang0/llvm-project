...
define i64 @indirect_tail(ptr %callee, i64 %value) {
...
; ASM-NOT: PUSHGO
; ASM: GO r255
define i64 @function_pointer_recursion(ptr %self, i64 %value) {
...
define i64 @callee_argument_overlap(ptr %callee, i64 %value) {
...
define i64 @stack_value_overlap(
    ...
    i64 %a13, i64 %a14, i64 %a15, i64 %a16, i64 %a17) {
...
; ASM: PUSHGO
; ASM: POP 0, 0
define i64 @stack_fallback_indirect(ptr %callee) {
  %result = tail call i64 %callee(
