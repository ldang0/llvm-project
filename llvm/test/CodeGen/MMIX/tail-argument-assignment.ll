...
; Tail-call selection remains separate from this shared pre-RA argument
; preparation. Every incoming value is captured in a virtual register before
; any destination register is overwritten.
...
; CHECK: DIRECT_CALL_STATE @zero_args
...
; CHECK: DIRECT_CALL_STATE @three_args
...
; CHECK: DIRECT_CALL_STATE @sixteen_args
...
; CHECK: DIRECT_CALL_STATE @converted_args
...
; CHECK: [[CALLEE:%[0-9]+]]:gpr64codegen = COPY $r231
; CHECK: $r231 = COPY
; CHECK: $r232 = COPY [[CALLEE]]
; CHECK: CALL_STATE [[CALLEE]]
