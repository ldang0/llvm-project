...
# RUN: echo '0xfe 0x01 0x00 0x35' | llvm-mc -triple=mmix -disassemble 2>&1 | FileCheck %s --check-prefix=INVALID
# RUN: echo '0xf6 0x15 0x01 0x01' | llvm-mc -triple=mmix -disassemble 2>&1 | FileCheck %s --check-prefix=INVALID
# RUN: echo '0xf6 0x35 0x00 0x01' | llvm-mc -triple=mmix -disassemble 2>&1 | FileCheck %s --check-prefix=INVALID
# RUN: echo '0xf7 0x35 0x00 0x01' | llvm-mc -triple=mmix -disassemble 2>&1 | FileCheck %s --check-prefix=INVALID
# RUN: echo '0xf7 0x15 0x01 0x01' | llvm-mc -triple=mmix -disassemble 2>&1 | FileCheck %s --check-prefix=INVALID
...
# RUN: echo '0xf9 0x00 0x01 0x00' | llvm-mc -triple=mmix -disassemble 2>&1 | FileCheck %s --check-prefix=INVALID
# RUN: echo '0xf9 0x00 0x00 0x02' | llvm-mc -triple=mmix -disassemble 2>&1 | FileCheck %s --check-prefix=INVALID
# RUN: echo '0xfa 0x01 0x01 0x00' | llvm-mc -triple=mmix -disassemble 2>&1 | FileCheck %s --check-prefix=INVALID
...
# RUN: echo '0xfb 0x00 0x01 0x01' | llvm-mc -triple=mmix -disassemble 2>&1 | FileCheck %s --check-prefix=INVALID
# RUN: echo '0xfc 0x01 0x00 0x00' | llvm-mc -triple=mmix -disassemble 2>&1 | FileCheck %s --check-prefix=INVALID
# RUN: echo '0xfc 0x00 0x01 0x00' | llvm-mc -triple=mmix -disassemble 2>&1 | FileCheck %s --check-prefix=INVALID
